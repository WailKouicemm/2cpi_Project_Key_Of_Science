...
class _ScheduleScreenState extends State<ScheduleScreen> {
  final sundayday = DaysPreferred(text: 'Sunday', couleur: Colors.white, boxcouleur:  const Color.fromRGBO(42,88,244,1),);
  final mondayday = DaysPreferred(text: 'Monday', couleur: Colors.white, boxcouleur:  const Color.fromRGBO(42,88,244,1),);
  final tuesdayday = DaysPreferred(text: 'Tuesday', couleur: Colors.white, boxcouleur:  const Color.fromRGBO(42,88,244,1),);
  final wednesdayday = DaysPreferred(text: 'Wednsday', couleur: Colors.white, boxcouleur: const  Color.fromRGBO(42,88,244,1),);
  final thursdayday = DaysPreferred(text: 'Thursday', couleur: Colors.white, boxcouleur: const  Color.fromRGBO(42,88,244,1),);
  final fridayday = DaysPreferred(text: 'Friyday', couleur: Colors.white, boxcouleur: const  Color.fromRGBO(42,88,244,1),);
  final saturdayday = DaysPreferred(text: 'Saturday', couleur: Colors.white, boxcouleur: const  Color.fromRGBO(42,88,244,1),);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar( 
        ...
        title:  const Text('KEYEINCE', style: TextStyle(fontSize: 22.0, color: Color.fromRGBO(42,88,244,1), fontWeight: FontWeight.bold),),
        actions:  [
          Padding(
            ...
            child: Row(
             ...
             Container(
               ...
               decoration: BoxDecoration(
                   ...
                   border: Border.all(color: const  Color.fromRGBO(42,88,244,1), width: 1.3)
               ),
                     ...
                     children: [
                       ...
                       const SizedBox(height: 20.0,),
                        Container(
                          decoration: BoxDecoration(
                                 borderRadius: BorderRadius.circular(10.0),
                                 border: Border.all(color:  const Color.fromRGBO(42,88,244,1), width: 2.0)
                                 ),
                          height: 45.0,
                          width: double.infinity,
                          child: FloatingActionButton.extended(
